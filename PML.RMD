...
min.merror.idx = which.min(bst.cv$evaluation[,test_merror_mean]) 
min.merror.idx 
# minimum merror
bst.cv$evaluation[min.merror.idx,]
```
...
```{r}
path<-setwd("C:/Users/Bhavi/Documents/PML/PML_files/figure-html")
